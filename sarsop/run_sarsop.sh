...
rm -f out.policy cmds.json poses.json lane_config.json autogenerated.pomdpx

cd ../ros-lanechanging/autocar/scripts/
rm -f poses.json cmds.json
...
rm out.policy cmds.json poses.json lane_config.json autogenerated.pomdpx
